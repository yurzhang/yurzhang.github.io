function overviewEchartsDraw(jsonName, mapId){
  ...
  $.get("../data/"+jsonName).done(function(data) { 
    ...
    option = {
        color:['#D48265','#2F4554','#61B1A8', '#C23531', '#91C7AE', ],
        title : {
            text: '本月各业务话单量占比',
            x:'center'
        },
        ...
        series: [
            {
                name:'网间',
                type:'line',
                data:[32723875567, 32111190698, 32815388288, 31786529384, 32788038370, 32031082922]
            },
            {
                name:'增值',
                type:'line',
            ...
            },
            {
                name:'国内漫游',
                type:'line',
                data:[73669733921, 74254733988, 78637955496, 79321450833, 89890991021, 97782770250]
            },
            {
                name:'国际漫游',
                type:'line',
                data:[611852069, 634158651, 634616409, 654902576, 723636143, 731210527]
            },
            {
                name:'其它',
                type:'line',
                // stack: '总量',
                data:[8483216783, 9412479717, 9609853507, 9609368654, 9518070513, 10853650338]
            }
        ]
    };
